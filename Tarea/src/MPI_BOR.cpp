    ...
    /**
     * @brief Illustrates how to use a bit-wise or reduction operation.
     * @details This application consists of a bit-wise or reduction; every MPI process
     * sends its value for reduction before the bit-wise or of these values is stored in
